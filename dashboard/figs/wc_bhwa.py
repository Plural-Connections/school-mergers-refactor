...
def make_dissim_scatterplot(save: bool = True, show: bool = False):
    ...
    filename_bhwa = (
        DATA_ROOT / "min_num_elem_4_constrained_bh_wa" / "consolidated_original.csv"
    )
    ...
    delta_bhwa = (df_bhwa["post_dissim_bh_wa"] - df_bhwa["pre_dissim_bh_wa"]) / df_bhwa[
        "pre_dissim_bh_wa"
    ]
